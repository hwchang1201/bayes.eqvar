...
data_generator_increasing <- function(n, p, n_rep, sig, edge_prob, lower_signal, eps, type){
  # input:
  # n : number of samples
  # p : number of covariates
  # n_rep : number of repeat.
...
data_generator_invgamma <- function(n, p, n_rep, sig, edge_prob, lower_signal, deg){
  # input:
  # n : number of samples
  # p : number of covariates
  # n_rep : number of repeat.
